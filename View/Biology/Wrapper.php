        ...
        <nav class="navbar navbar-static-top">
            <div class="container">
                ...
                <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
                    ...
                    <form class="navbar-form navbar-left" role="search">
                        <div class="form-group">
                            <input onkeyup="this.value && carbon.startApplication('/Search/' + this.value)" type="text" class="form-control"
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="<?= SITE ?>Chapters">Chapters <span class="sr-only">(current)</span></a></li>
                    </ul>
                </div>
                <!-- /.navbar-custom-menu -->
            </div>
